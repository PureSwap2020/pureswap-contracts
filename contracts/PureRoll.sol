...
import "./pureswap/interfaces/IUniswapV2Router01.sol";
import "./pureswap/interfaces/IUniswapV2Factory.sol";
import "./pureswap/libraries/UniswapV2Library.sol";

// PureRoll helps your migrate your existing Uniswap LP tokens to PureSwap LP ones
contract PureRoll {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'PureRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'PureRoll: INSUFFICIENT_B_AMOUNT');
    }
    ...
    function pairForOldRouter(address tokenA, address tokenB) internal view returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'df8e89997c89ca34ebef40dcd5d0e970c38369aeb034d8cd672c748de256f869' // init code hash
            ))));
    }
